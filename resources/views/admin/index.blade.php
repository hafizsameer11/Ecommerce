                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                               <img class="rounded-circle" src="{{ asset('assets/admin/images/users/avatar-2.jpg') }}" alt="user" width="30">
 </td>
                                                            <td>
                                                                <a href="javascript:void(0);">Ruby T. Curd</a>
                                                            </td>
                                                            <td>                                                                
<img src="{{ asset('assets/admin/images/flags/us_flag.jpg') }}" alt="" class="img-flag">
                                                            </td>                           
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                              <img class="rounded-circle" src="{{ asset('assets/admin/images/users/avatar-3.jpg') }}" alt="user" width="30">
 </td>
                                                            <td>
                                                                <a href="javascript:void(0);">William A. Johnson</a>
                                                            </td>
                                                            <td>                                                                
                                                               <img src="{{ asset('assets/admin/images/flags/french_flag.jpg') }}" alt="" class="img-flag">
                                                        ...
                                                        <tr>
                                                            <td>
                                                               <img class="rounded-circle" src="{{ asset('assets/admin/images/users/avatar-4.jpg') }}" alt="user" width="30">
</td>
                                                            <td>
                                                                <a href="javascript:void(0);">Bobby M. Gray</a>
                                                            </td>
                                                            <td>                                                                
                                                                <img src="{{ asset('assets/admin/images/flags/spain_flag.jpg') }}" alt="" class="img-flag">
