                                                ...
                                                <div class="table-responsive mb-20">
                                                    <table class="shop_table-2 cart table">
                                                        ...
                                                        <tbody>
                                                            <tr class="cart_item">
                                                                <td class="item-img">
                                                                    <a href="#"><img src="{{ asset('assets/website/images/product/01.webp') }}" alt="">
                                                                    </a>
                                                                </td>
                                                            ...
                                                            <tr class="cart_item">
                                                                <td class="item-img">
                                                                    <a href="#"><img src="{{ asset('assets/website/images/product/02.webp') }}" alt="">
                                                                    </a>
                                                                </td>
                                                                <td class="item-title"> <a href="#">Fusce Laoreet
                                                                        Volutpat </a></td>
                                                            ...
                                                            <div class="panel-group" id="accordion" role="tablist"
                                                                ...
                                                                <div class="panel panel-checkout">
                                                                    <div class="panel-heading" role="tab"
                                                                        id="headingThree">
                                                                        <h4 class="panel-title">
<img src="{{ asset('images/icons/acc.webp') }}" alt="">                                                                            Have A Coupon?
                                                                            <a class="collapsed" role="button"
                                                                                data-bs-toggle="collapse"
                                                                                data-bs-parent="#accordion"
                                                                                href="#collapseThree"
